        ...
        <div className="pt-28 pb-8 md:pt-36 md:pb-16">
          ...
          <div className="max-w-3xl text-center md:text-left">
            ...
            <h1 className="text-5xl md:text-6xl font-bold mb-6">
              Find open source alternatives to every <span className="font-handwriting text-indigo-500 font-normal">software</span>
            </h1>
            ...
            <div className="sm:flex sm:items-center sm:justify-center md:justify-start space-y-6 sm:space-y-0 sm:space-x-5">
              <div>
                <Link className="inline-flex items-center justify-center px-6 py-3 text-white bg-indigo-500 hover:bg-indigo-600 font-medium rounded-lg shadow-sm transition-colors" href="#alternatives">
                  Explore Alternatives
                </Link>
              </div>
              <div className="sm:flex sm:items-center sm:justify-center space-y-2 sm:space-y-0 sm:space-x-3">
                <div className="text-sm text-gray-500 font-medium">
                  Trusted by <span className="text-indigo-500">100K+</span> Developers
                </div>
              </div>
            </div>
          </div>
