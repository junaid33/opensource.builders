        ...
        <Box ml="auto" mr="auto" maxWidth="80rem" px={2} py={4}>
          <Box>
            ...
            >
              ...
              {/* <Box bg="#122a4f" borderRadius={4} mx={1} mb={6} p={3}>
            <Box mb={5}>
              <Box display="flex">
                <Box>
                  <Box color="gray.200" mx={2} mb={1} fontWeight={500}>
                    License
                  </Box>
                  <Box display="flex" flexWrap="wrap">
                    <PseudoBox
                    ...
                    {licenses.map(c => (
                      <PseudoBox
                        ...
                        m={2}
                        borderRadius={4}
                        color={license !== c && "white"}
                        fontWeight={600}
                        letterSpacing="wide"
                        bg={license === c ? "white" : "#00bf70"}
                        textTransform="uppercase"
                        _hover={license !== c && { bg: "#029c5d" }}
                        onClick={() => this.licenseFilter(c)}
                        cursor="pointer"
                ...
                <Box>
                  ...
                  <Box display="flex" flexWrap="wrap">
                    <PseudoBox
                      ...
                      m={2}
                      borderRadius={4}
                      color={language !== "" && "white"}
                      fontWeight={600}
                      letterSpacing="wide"
                      bg={language === "" ? "white" : "orange.500"}
                      textTransform="uppercase"
                      _hover={language !== "" && { bg: "#af5417" }}
                      onClick={() => this.languageFilter("")}
                      cursor="pointer"
                    ...
                    {languages.map(c => (
                      <PseudoBox
                        ...
                        m={2}
                        borderRadius={4}
                        color={language !== c && "white"}
                        fontWeight={600}
                        letterSpacing="wide"
                        bg={language === c ? "white" : "orange.500"}
                        textTransform="uppercase"
                        _hover={language !== c && { bg: "#af5417" }}
                        onClick={() => this.languageFilter(c)}
                        cursor="pointer"
              ...
              <Box display="flex" flexWrap="wrap">
                ...
                {categories.map(c => (
                  <PseudoBox
                    ...
                    m={2}
                    borderRadius={4}
                    color={category !== c && "white"}
                    fontWeight={600}
                    letterSpacing="wide"
                    bg={category === c ? "white" : "#2b4a7b"}
                    textTransform="uppercase"
                    _hover={category !== c && { bg: "#1a3765" }}
                    onClick={() => this.categoryFilter(c)}
                    cursor="pointer"
